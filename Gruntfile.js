...
module.exports = function (grunt) {
	...
	const projectFiles = {
		...
		scss: [
			...
			// {
			// 	cwd: 'libs/framework/assets/sass/',
			// 	src: ['*.scss'],
			// 	dest: 'libs/framework/assets/css/'
			// },
		],
		js: [
			{
				cwd: projectConfig.srcDir + 'src/js/',
				src: ['blocks.js'],
				dest: projectConfig.srcDir + 'assets/js/'
			},
			// {
			// 	cwd: projectConfig.srcDir + 'libs/framework/assets/src/',
			// 	src: ['ekit-admin-core.js'],
			// 	dest: projectConfig.srcDir + 'libs/framework/assets/js/'
			// },
		]
	}
